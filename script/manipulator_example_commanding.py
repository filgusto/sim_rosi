...
def getCommand():
    ...
    return arm_joints_target_pos

# main script
if __name__=='__main__':

    # initialize node
    rospy.init_node('manipulator_example_commanding', anonymous=True)

    # sends a message to the user
    rospy.loginfo('manipulator_example_commanding node started')

    # registering publisher
    pub_arm_cmd = rospy.Publisher('/manipulator/joints_target_command', ManipulatorJoints, queue_size=1)
