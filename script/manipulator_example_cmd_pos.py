...
if __name__=='__main__':
    ...
    # initialize node
    rospy.init_node('manipulator_example_cmd_pos', anonymous=True)

    # sends a message to the user
    rospy.loginfo('manipulator_example_cmd_pos node started')

    # registering publisher
    pub_arm_cmd = rospy.Publisher('/manipulator/cmd/joints_pos_target', ManipulatorJoints, queue_size=1)
